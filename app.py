...
set_background('background/2.jfif')

# Streamlit app title
st.title("Project : Medicinal Plant Identification using yolov8")
...
WIDTH, HEIGHT = 65, 65
categories = ['Alpinia Galanga','Amaranthus Viridis','Artocarpus Heterophyllus','Azadirachta Indica' ,'Basella Alba','Brassica Juncea',]
...
st.write("Upload up to images to get the predictions.")
...
if uploaded_files:
    ...
    st.write("Please upload up to  image files.")
